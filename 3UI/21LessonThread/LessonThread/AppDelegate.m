...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSThreadViewController *threadVC = [[NSThreadViewController alloc] init];
    ...
    NSConditionViewController *conditionVC = [[NSConditionViewController alloc] init];
    UINavigationController *navigationVC = [[UINavigationController alloc] initWithRootViewController:gcdVC];
