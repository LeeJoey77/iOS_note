...
class WebViewViewController: UIViewController, UIWebViewDelegate {
    ...
    func setNavBar() {
        ...
        let btnBack = UIBarButtonItem(title: "Back",
                                      style: .plain,
                                     target: self,
    ...
    @IBAction func swift_js_nopara(_ sender: UIButton) {
        self.webView.stringByEvaluatingJavaScript(from: "Swift_JS1()")
        //或
//        context.evaluateScript("Swift_JS1()")
    ...
    @IBAction func swift_js_para(_ sender: UIButton) {
        self.webView.stringByEvaluatingJavaScript(from: "Swift_JS2('oc','swift')")
//        self.webView.stringByEvaluatingJavaScript(from: "let a=1,b=2;alert(a+b)")
        //或
...
//        (2）在映射 block 到 JavaScript方法调用之前，我们需要 unsafeBitCast 函数将 block 转成为 AnyObject
        ...
        self.context.setObject(unsafeBitCast(closure1, to: AnyObject.self), forKeyedSubscript: "" as NSCopying & NSObjectProtocol)
        ...
        self.context.setObject(unsafeBitCast(closure2, to: AnyObject.self), forKeyedSubscript: "test2" as NSCopying & NSObjectProtocol)
